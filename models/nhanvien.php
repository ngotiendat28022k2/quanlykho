...
class NhanVien
{
    ...
    {
        $db = DB::getInstance();
        $query = 'UPDATE NhanVien SET TenNV = :ten, DienThoai = :dienthoai, Email = :email, DiaChi = :diachi, IsActive = :isactive WHERE Id = :id';
        ...
        // Điều hướng về trang danh sách nhân viên và thêm tham số thông báo
        header('Location: index.php?controller=nhanvien&action=index&message=thanhcong');
        exit();
    }
